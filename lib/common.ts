...
function flagsForAnalyseOptions(options: types.AnalyseOptions, isTTY: boolean, logLevelDefault: types.LogLevel, writeDefault: boolean):
    ...
    service: {
      ...
      analyse(options, isTTY, callback) {
        ...
        try {
          let key = nextBuildKey++;
          let writeDefault = !streamIn.isBrowser;
          let [flags, write, plugins, stdin, resolveDir] = flagsForAnalyseOptions(options, isTTY, logLevelDefault, writeDefault);
